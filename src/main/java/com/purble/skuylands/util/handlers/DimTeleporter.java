...
public class DimTeleporter extends net.minecraft.world.Teleporter {

	private final WorldServer world;
	private double x,y,z;
	public DimTeleporter(WorldServer world, double x, double y, double z) 
	{
		super(world);
		this.world = world;
		this.x = x;
            ...
            for (int k1 = -2; k1 <= 2; ++k1)
            {
                for (int l1 = -1; l1 < 3; ++l1)
                {
                    ...
                    if(this.world.provider.getDimension() != 0)
                    	this.world.setBlockState(new BlockPos(i2, j2, k2), flag ? Blocks.BEDROCK.getDefaultState() : Blocks.AIR.getDefaultState());
                }
            }
        }
