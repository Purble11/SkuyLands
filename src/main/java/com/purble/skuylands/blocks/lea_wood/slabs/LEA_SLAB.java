...
public abstract class LEA_SLAB extends BlockSlab {

	Block half;
	public static final PropertyEnum<Variant> VARIANT = PropertyEnum.<Variant>create("variant", Variant.class);
	
	public LEA_SLAB(String name, Material materialIn, BlockSlab half) {
		super(materialIn);
		...
		if(!this.isDouble()) state.withProperty(HALF, EnumBlockHalf.BOTTOM);
