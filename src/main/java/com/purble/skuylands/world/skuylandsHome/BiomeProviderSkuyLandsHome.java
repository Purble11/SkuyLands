...
public class BiomeProviderSkuyLandsHome extends BiomeProvider {

	private GenLayer genBiomes;
	private GenLayer biomeIndexLayer;
	private BiomeCache biomeCache;

	public BiomeProviderSkuyLandsHome() {
		this.biomeCache = new BiomeCache(this);
	}

	public BiomeProviderSkuyLandsHome(long seed) {
		this();
		GenLayer[] agenlayer = GenLayerFixSkuyLandsHome.createWorld(seed);
		this.genBiomes = agenlayer[0];
		this.biomeIndexLayer = agenlayer[1];
	}

	public BiomeProviderSkuyLandsHome(World world) {
		this(world.getSeed());
	}
